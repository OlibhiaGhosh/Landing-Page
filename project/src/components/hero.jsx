    ...
    <>
      ...
      >
        <div className="absolute inset-0 md:ml-20 lg:ml-40 xl:ml-52 2xl:ml-64">
          <h1 className="text-white text-3xl font-sans md:text-5xl lg:text-4xl xl:text-5xl font-semibold mt-28 py-3 px-4 xl:p-4 md:mt-48 lg:mt-20 xl:mt-36">
            Empowering Lives Through
            <br />
            Innovative <a className=" underline decoration-button-color">AI</a> Technologies.{" "}
          </h1>
